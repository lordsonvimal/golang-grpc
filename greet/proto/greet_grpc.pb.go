...
func (c *greetServiceClient) GreetClientStream(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[1], "/greet.GreetService/GreetClientStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *greetServiceClient) GreetBiDirectionStream(ctx context.Context, opts ...grpc.CallOption) (GreetService_GreetBiDirectionStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &GreetService_ServiceDesc.Streams[2], "/greet.GreetService/GreetBiDirectionStream", opts...)
	if err != nil {
		return nil, err
	}
